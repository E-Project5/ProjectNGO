...
const Home = () => {
        ...
        const getData = async () => {
            try {
                ...
                if (Response.ok) {
                    ...
                    setMainImage(fetchData.data[0].MainImage)
                }
            } catch (error) {
                console.log(error)
            }
    ...
    return (
        ...
        {/* background-image:url(../img/hero/hero_arrow.png) */}
            <main>
                {/* <!-- slider Area Start--> */}
                <div class="slider-area" style={{backgroundImage:`url(${MainImage})`}}>
                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 col-md-8 col-sm-10">
                                        <div class="hero__caption">
                                            <h1 data-animation="fadeInUp" data-delay=".6s">{MainTitle}</h1>
                                            <p data-animation="fadeInUp" data-delay=".8s" >{SubTitle}</p>
                                            {/* <!-- Hero-btn --> */}
                                            <div class="hero__btn">
